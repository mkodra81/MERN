      ...
      <Container>
        <Row>
          ...
          <Col md={4}>
            ...
            <Nav className="social-icons">
              <Nav.Link href="https://facebook.com" className="text-white" target="_blank">
                <FontAwesomeIcon icon={faFacebook} />
              </Nav.Link>
              <Nav.Link href="https://twitter.com" className="text-white" target="_blank">
                <FontAwesomeIcon icon={faTwitter} />
              </Nav.Link>
              <Nav.Link href="https://instagram.com" className="text-white" target="_blank">
                <FontAwesomeIcon icon={faInstagram} />
              </Nav.Link>
              <Nav.Link href="https://linkedin.com" className="text-white" target="_blank">
        ...
        <Row className="mt-4">
          <Col className="text-center">
            <p className="mb-0">&copy; {new Date().getFullYear()} MovieStream. All rights reserved.</p>
          </Col>
        </Row>
      </Container>
    </footer>
